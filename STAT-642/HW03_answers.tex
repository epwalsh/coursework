...
if and only if 
\[ P\left(\lim_{n\rightarrow\infty}\frac{|X_{n}|}{n} = 0\right) = 1 \qquad \text{if and only if} \qquad P\left(\lim_{n\rightarrow\infty}\frac{X_{n}}{n} = 0\right) = 1. \]
\end{Proof}
...
\[ P\left( \lim_{n\rightarrow\infty}\frac{M_{n}}{n^{\alpha}} < \epsilon \right) = P\left( \lim_{n\rightarrow\infty}|X_{n}| < n^{1/\alpha}\epsilon
\right) = 1. \]
