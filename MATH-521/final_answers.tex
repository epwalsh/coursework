...
\begin{Solution}
  ...
  \begin{align*}
    P(|B_n| \leq n^{\alpha}) & \leq P(|B_1(n)| \leq n^{\alpha}) P(|B_2(n)| \leq n^{\alpha}) P(|B_3(n)| \leq n^{\alpha}) \\
    & = P(|B_1(n)| \leq n^{\alpha})^3 \\
    & = P \left( \frac{|B_1(n)|}{\sqrt{n}} \leq n^{\alpha - 1/2} \right) \\
...
\begin{Solution}
  ...
  \begin{align*}
    ...
    & = \sum_{i=1}^{3} 2P(|B_i(1)| \geq n^{\alpha}/2) \\
