...
\begin{Solution}
  ...
  \end{claim}
  \begin{claimproof}
    Consider the Borel measure space on $[0, 1]$. Let $X \equiv 0$ and define $X_n$ as follows: $X_1 \equiv 1$, $X_2 = \bm{1}_{[0,1/2]}$, $X_3 = \bm{1}_{[1/2,1]}$, $X_4 = \bm{1}_{[0,1/4]}$, $X_5 = \bm{1}_{[1/4,1/2]}, \dots$. Then for all $0 < \epsilon \leq 1$,
    \[
  ...
  \end{claim}
  \begin{claimproof}
    Follows by Claims 2 and 3, i.e. that (ii) implies (iv) and (iii) implies (ii).
  ...
  \end{claim}
  \begin{claimproof}
    Follows by Claims 1 and 6, i.e. that (i) implies (ii) and (i) does not imply (iii), since if (ii) implied (iii) then (i) would imply (ii).
  \end{claimproof}
